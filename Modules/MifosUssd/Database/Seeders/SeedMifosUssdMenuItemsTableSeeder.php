...
class SeedMifosUssdMenuItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('mifos_ussd_menu_items')->insert(array(
            ...
            array(
                'menu_id' => 23,
                'description' => 'Enter National ID(Unique Identifier)',
                'next_menu_id' => 23,
                'step' => 1,
                'validation' => '',
                'confirmation_phrase' => 'National ID',
            ),
            array(
                'menu_id' => 21,
            ...
            array(
                ...
                'next_menu_id' => 0,
                'step' => 1,
                'validation' => 'nationalId_preset',
                'confirmation_phrase' => 'IGNORE',
            ),
            array(
                'menu_id' => 28,
                'description' => 'Set PIN:'.PHP_EOL.'Enter your 4 digit PIN',
                'next_menu_id' => 0,
                'step' => 2,
                'validation' => 'min:4|max:4',
                'confirmation_phrase' => 'PIN',
